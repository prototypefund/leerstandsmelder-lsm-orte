class AddTokensToUsers < ActiveRecord::Migration[6.1]
  def up
    add_column :users, :provider, :string, null: false, default: 'email', if_not_exists: true
    add_column :users, :uid, :string, null: false, default: '', if_not_exists: true
    add_column :users, :tokens, :text, if_not_exists: true
    ...
    add_column :users, :allow_password_change, :boolean, default: false, if_not_exists: true
